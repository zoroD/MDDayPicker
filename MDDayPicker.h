...
static NSInteger const DAY_PICKER_WEEKDAY_SUNDAY_FIRST = 1;
static NSInteger const DAY_PICKER_WEEKDAY_MONDAY_FIRST = 2;

@interface MDDayPicker : UIView
...
// Days for custom the date btn color
