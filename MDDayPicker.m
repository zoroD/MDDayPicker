...
@interface MDDayPicker()<UIScrollViewDelegate> {
...
//    [_calendar setLocale:[[NSLocale alloc] initWithLocaleIdentifier:@"en-US"]];
...
//    [_calendar setFirstWeekday:1];
    ...
    self.weekdayTitles = [MDDayPicker weekdayTitlesWithLocaleIdentifier:nil length:4 uppercase:YES firstWeekday:_firstWeekday];

    self.selectedDateBackgroundImage = [MDDayPicker imageWithColor:self.tintColor];
...
- (void)setSelectedDateBackgroundColor:(UIColor *)selectedDateBackgroundColor {
    ...
    self.selectedDateBackgroundImage = [MDDayPicker imageWithColor:selectedDateBackgroundColor];
}
...
//        b.contentEdgeInsets = UIEdgeInsetsMake(0, 0, 0, 0);
//    }
    b.contentEdgeInsets = UIEdgeInsetsMake(0, 0, 9, 0);
